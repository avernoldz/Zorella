                ...
                <div class="col body">
                    <div class="row">
                        <div class="col-12 body" style="background-color: var(--main-300);color: white;">
                            <h4><i class="fa-solid fa-plane"></i> Customize</h4>
                        </div>
                    </div>
...
?>
                        ...
                        <div class="row mt-5 wd-100">
                            <div class="col-4">
                                <label for="">Hotel</label><label for="" class="required">*</label>
                                <input type="text" class="form-control" name="hotel" placeholder="Okada">
                            </div>
                            <div class="col-4">
