                ...
                <div class="col body">
                    <div class="row">
                        <div class="col-12 body" style="background-color: var(--main-300);color: white;">
                            <h4><i class="fa-solid fa-plane"></i> Educational/Team building</h4>
                        </div>
                    </div>
                    ...
                    <div class="row body">
                        ...
                        <div class="row mt-5 wd-100">
                            <div class="col-4">
                                <label for="departure-date">Start Date</label><label for="" class="required">*</label>
                                <input type="date" id="departure-date" placeholder="Departure" name="departure-date"
                                    class="form-control" required>
                            </div>
                            <div class="col-4">
                                <label for="arrival-date">End Date</label><label for="" class="required">*</label>
                                <input type="date" id="arrival-date" placeholder="Arrival" name="arrival-date"
                                    class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row mt-5 wd-100">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control" placeholder="4" min="1" name="pax">
                            </div>
                        </div>
                        ...
                        <div class="row mt-5 wd-100">
                            <div class="col-4">
                                ...
                                <input type="text" name="position" class="form-control" required
                                    placeholder="President,Manager,CEO,Staff">
                            </div>
                            <div class="col-8">
