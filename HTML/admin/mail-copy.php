...
require 'C:\xampp\htdocs\Zorella\vendor\autoload.php'; // For Dompdf
include 'C:\xampp\htdocs\Zorella\inc\Include.php';
...
$pdfFilePath = 'C:\xampp\htdocs\Zorella\HTML\admin\quotation\.' . $quotationRows['firstname'] . $quotationRows['lastname'] . $date . '.pdf'; // Adjust the path as needed
...
$mail->addAddress('averemocling@gmail.com');
