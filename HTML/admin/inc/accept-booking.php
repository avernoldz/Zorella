...
function processBooking($conn, $mail)
{
    ...
    $pdfFilePath = savePDF($body, $firstRow);
...
function savePDF($body, $firstRow)
{
    ...
    $date = date('Ymds');
    $pdfFilePath = '../confirmation-bookings/' . $firstRow['user_firstname'] . $firstRow['user_lastname'] . $date . '.pdf'; // Adjust the path as needed
