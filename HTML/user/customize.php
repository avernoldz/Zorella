                ...
                <div class="col body">
                    ...
                    <div class="row body">
                        ...
                        <div class="col-4 mt-4">
                            ...
                            <input type="text" name="hotel" id="hotel" class="form-control" placeholder="Okada, Manila Suite, Dusit Thani">
                        </div>

                        <div class="col-4 mt-4">
                            <label for="attraction">Attraction</label>
                            <input type="text" name="attraction" id="attraction" class="form-control" placeholder="Zipline, Trekking, Banana Boat, Island Hopping">
                        </div>
