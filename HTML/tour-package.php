                ...
                <div class="col body">
                    ...
                    <div class="row body">
                        <div class="row mt-5 wd-100">
                            <div class="col-4">
                                <img src="../Assets/best2.jpg" alt="tour-package" width="100%">
                            </div>
                            <div class="col-4">
                                <img src="../Assets/best3.jpg" alt="tour-package" width="100%">
                            </div>
                            <div class="col-4">
                                <img src="../Assets/best4.jpg" alt="tour-package" width="100%">
                            </div>
                        </div>

                        <div class="row mt-5 wd-100">
                            <div class="col-4">
                                <img src="../Assets/top2.jpg" alt="tour-package" width="100%">
                            </div>
                            <div class="col-4">
                                <img src="../Assets/top3.jpg" alt="tour-package" width="100%">
                            </div>
                            <div class="col-4">
                                <img src="../Assets/top4.jpg" alt="tour-package" width="100%">
                            </div>
                        </div>
                        ...
                        <div class="row mt-5 wd-100">
                            ...
                            <div class="col-4">
                                <img src="../Assets/top5.jpg" alt="tour-package" width="100%">
                            </div>
                            <div class="col-4">
                                <img src="../Assets/top6.jpg" alt="tour-package" width="100%">
                            </div>
                            <div class="col-4">
                                <img src="../Assets/top7.jpg" alt="tour-package" width="100%">
                            </div>
                        </div>
